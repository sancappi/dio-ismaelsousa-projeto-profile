    ...
    return (
        <SafeAreaView style={style.container}>
          ...
          <View style={style.content}>
            ...
            <Text 
              accessibilityLabel="Descrição: Software engineer | Leader tech at Fleye 
              | Mobile Developer | Mentor at Catapulta.club @ismaelmoreiraa"
              style={[style.defaultText, style.description]}>
              Software engineer | Leader tech at Fleye 
              | Mobile Developer | Mentor at Catapulta.club @ismaelmoreiraa
              Ismael Moreira
            </Text>
